...
parser.add_argument('--model', default='DFFNet_L', type=str, help='model name')
parser.add_argument('--num_workers', default=16, type=int, help='number of workers')
parser.add_argument('--data_dir', default='/sdc/wwj/', type=str, help='path to dataset')
parser.add_argument('--save_dir', default='./saved_models/', type=str, help='path to models saving')
parser.add_argument('--result_dir', default='./results/', type=str, help='path to results saving')
parser.add_argument('--dataset', default='Haze4K', type=str, help='dataset name')
parser.add_argument('--exp', default='haze4k', type=str, help='experiment setting')

parser.add_argument('--saved_weight_dir',
                    default='/home/ubuntu/515wwj/ImageDehazing/DFFNet/weights/DFFNet_L/haze4k/DFFNet_L.pth', type=str,
                    help='weight dir')
...
def test(test_loader, network, result_dir):
    ...
    for idx, batch in enumerate(test_loader):
        ...
        with torch.no_grad():
            output = network(input)[:, :, :h, :w].clamp_(-1, 1)
...
if __name__ == '__main__':
    ...
    #     "/home/ubuntu/515wwj/ImageDehazing/DFFNet/weights/DFFNet_S/haze4k/DFFNet_S" + ".pth")
    # saved_model_dir = os.path.join(
    #     "/home/ubuntu/515wwj/ImageDehazing/DFFNet/weights/DFFNet_L/haze4k/DFFNet_L" + ".pth")
    saved_model_dir = args.saved_weight_dir
