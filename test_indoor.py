...
parser.add_argument('--saved_weight_dir',
                    default='/home/ubuntu/515wwj/ImageDehazing/DFFNet/weights/DFFNet_L/indoor/DFFNet_L.pth', type=str,
                    help='weight dir')
...
if __name__ == '__main__':
    ...
    #     "/home/ubuntu/515wwj/ImageDehazing/DFFNet/weights/DFFNet_T/indoor/DFFNet_T" + ".pth")
    # saved_model_dir = os.path.join(
    #     "/home/ubuntu/515wwj/ImageDehazing/DFFNet/weights/DFFNet_S/indoor/DFFNet_S" + ".pth")
    # saved_model_dir = os.path.join(
    #     "/home/ubuntu/515wwj/ImageDehazing/DFFNet/weights/DFFNet_L/indoor/DFFNet_L" + ".pth")
