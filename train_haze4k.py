...
parser.add_argument('--model', default='DFFNet_S', type=str, help='model name')
...
if __name__ == '__main__':
    ...
    # checkpoint=torch.load('/home/ubuntu/515wwj/ImageDehazing/DFFNet/weights/DFFNet_S/haze4k/DFFNet_S.pth')
    checkpoint = None
